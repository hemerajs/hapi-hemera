...
const internals = {
  defaults: {
    ...
    nats: {},
    // prefix to allow chairo and hemera to co-exist
    hapiDecoratePrefix: ''
  }
}
...
exports.register = function (server, options, next) {
  ...
  server.decorate('server', [options.hapiDecoratePrefix || '', 'action'].join(''), internals.action(server))
  server.decorate('reply', [options.hapiDecoratePrefix || '', 'act'].join(''), internals.replyAct)
  server.handler([options.hapiDecoratePrefix || '', 'act'].join(''), internals.handlerAct)
