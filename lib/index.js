...
exports.register = function (server, options, next) {
  ...
  server.decorate('request', 'pattern', (request) => {
    let basePattern = {}

    if (typeof settings.basePattern === 'function') {
      basePattern = settings.basePattern(request) || {}
    } else {
      basePattern = settings.basePattern || {}
    }
    ...
    return function (pattern) {
      ...
      return Object.assign(basePattern, pattern)
    }
  }, {
    apply: true
  })
